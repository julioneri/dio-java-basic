...
Um jogo de Sudoku simples feito em Java, com foco em aprendizado e boas práticas de código orientado a objetos.

Agora com suporte a **interface gráfica (UI)**, além da tradicional execução via **terminal**.
...
- 🪟 **Nova interface gráfica com visual intuitivo**
